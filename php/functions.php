...
/**
 * Registrar un Custom Post Type para "Servicios"
 */
function registrar_cpt_servicios() {
    $args = array(
        'labels'      => array('name' => 'Servicios', 'singular_name' => 'Servicio'),
        'public'      => true,
        'has_archive' => true, // Esto crea la url /servicios/ automáticamente
        'menu_icon'   => 'dashicons-hammer', // Icono de martillo en el panel
        'supports'    => array('title', 'editor', 'thumbnail'), // Título, texto y foto principal
        'rewrite'     => array('slug' => 'servicios'),
        'show_in_rest' => true, // Importante para que funcione con el editor moderno
    );
...
/**
 * Personalizar el copyright en el footer
 */
function tu_custom_copyright() {
    // Esto saca el año actual automáticamente
    $anio_actual = date('Y'); 
    ?>
    <span class="copyright-bar">
        © <?php echo $anio_actual; ?> <strong>Servitec Clima & Solar</strong> • Especialistas en Confort Térmico <br>
        <a href="/politica-privacidad">Política de Privacidad</a> | <a href="/contacto">Contacto</a>
    </span>
    <?php
}
